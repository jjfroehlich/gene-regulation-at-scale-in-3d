#!/usr/bin/env python3
"""Create a small README GIF fallback from existing tracked V5 stills."""
...
DEFAULT_OUTPUT = ROOT / "docs" / "images" / "v5-flythrough-preview.gif"
DEFAULT_INPUTS = [
    ROOT / "docs" / "images" / "v5-overview.jpg",
    ROOT / "docs" / "images" / "v5-p53-dna.jpg",
    ROOT / "docs" / "images" / "v5-transcription-start.jpg",
    ROOT / "docs" / "images" / "v5-nucleosome-loop.jpg",
    ROOT / "docs" / "images" / "v5-translation.jpg",
    ROOT / "docs" / "images" / "v5-actin.jpg",
]
CAPTIONS = [
    "V5 flythrough: annotated canonical overview",
    "p53 tetramer bound to DNA",
    "RNA polymerase II and nascent RNA",
