...
$Blend = Join-Path $Root "outputs\canonical\gene_expression_surface_style.blend"
$Exporter = Join-Path $Root "scripts\export_sketchfab_models.py"
$Fbx = Join-Path $Root "outputs\sketchfab\gene_expression_canonical_sketchfab.fbx"
...
Get-Item (Join-Path $Root "outputs\sketchfab\gene_expression_canonical_sketchfab.glb"), $Fbx |
